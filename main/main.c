...
#define I2C_MASTER_SDA_IO GPIO_NUM_0     /*!< gpio number for I2C master data  */
#define I2C_MASTER_NUM I2C_NUM_0  /*!< I2C port number for master dev */
#define I2C_MASTER_FREQ_HZ 400000 /*!< I2C master clock frequency */

static const char *TAG = "mpu6050 not a test";
...
void app_main()
{
    ...
    //xTaskGetTickCount() - start) < (4000 / portTICK_PERIOD_MS
    //(xTaskGetTickCount() - start) < (4000 / portTICK_PERIOD_MS)
    ...
    while(1) {
        ...
        printf("%.2f %.2f %.2f %.2f %.2f %.2f\n", gyro.gyro_x, gyro.gyro_y, gyro.gyro_z, acce.acce_x, acce.acce_y, acce.acce_z);


        //ESP_LOGI(TAG, "%.2f gyro_y:%.2f, gyro_z:%.2f, acce_x:%.2f, acce_y:%.2f, acce_z:%.2f\n", gyro.gyro_x, gyro.gyro_y, gyro.gyro_z, acce.acce_x, acce.acce_y, acce.acce_z);
